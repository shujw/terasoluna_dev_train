  ...
  <script type="text/javascript">
    jQuery(function(){
      ...
      $('#update').click(function(){
        ...
        $('#eventForm').attr('action', 'event/update');
        $('#eventForm').submit();
        return false;
      });
      $('#delete').click(function(){
        $('#eventForm').attr('action', 'event/delete');
        $('#eventForm').submit();
        return false;
      });
...
<div class="imui-form-container">
  ...
  <form:form name="eventForm" modelAttribute="eventForm" action="" method="POST">
      ...
      <tbody>
        <tr>
          <th>
            ...
            <label>イベント名</label>
             -->
            <label class="imui-required">イベント名</label>
          </th>
          <td>
            <!-- 
            <p>${f:h(eventForm.eventName)}</p>
             -->
            <imui:textbox id="eventName" name="eventName" value="${eventForm.eventName}" size="50"/>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <!-- 
            <imui:textArea id="eventDetail" name="eventDetail" value="${eventForm.eventDetail}" rows="3" cols="40" readonly/>
             -->
        ...
        <tr>
          ...
          <td>
            <!-- 
            <p>${f:h(eventForm.entryUser)}</p>
             -->
            <!-- 
            <p>${f:h(eventForm.entryUserName)}</p>
             -->
    ...
    <input type="hidden" id="eventId" name="eventId" value="${f:h(eventForm.eventId)}"/>
  </form:form>
</div>
